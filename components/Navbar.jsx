      ...
      >
        <Navbar.Brand onClick={() => (window.location = "/#about")}>
          <div className="d-flex flex-row p-1">
            <span className="d-block d-lg-none ps-2">Clemmie Kwiatkowska</span>
            <span className="d-block d-lg-none ps-3">
              ...
              >
                <div>
                  {isDarkMode === true ? (
                    <CgSun color="#ffc107" size="2ren" />
                  ) : (
                    <BiMoon color="#007BFF" size="2rem" />
                  )}
                </div>
              </div>
            </span>
